    ...
    <section class="row g-4">
        ...
        <article class="col-md-4">
            <div class="card h-100 border-team-williams" style="border-top-width: 5px;">
                <img src="{{ asset('img/logo-williams.jpeg') }}" class="card-img-top" alt="Williams" style="object-fit: cover; height: 220px;">
                <div class="card-body p-4 d-flex flex-column">
        ...
        <article class="col-md-4">
            <div class="card h-100 border-team-haas" style="border-top-width: 5px;">
                <img src="{{ asset('img/logo-haas.jpeg') }}" class="card-img-top" alt="Haas" style="object-fit: cover; height: 220px;">
                <div class="card-body p-4 d-flex flex-column">
        ...
        <article class="col-md-4">
            <div class="card h-100 border-team-sauber" style="border-top-width: 5px;">
                <img src="{{ asset('img/logo-stake.jpeg') }}" class="card-img-top" alt="Sauber" style="object-fit: cover; height: 220px;">
                <div class="card-body p-4 d-flex flex-column">
        ...
        <article class="col-md-4">
            <div class="card h-100 border-team-rb" style="border-top-width: 5px;">
                <img src="{{ asset('img/logo-rb.jpeg') }}" class="card-img-top" alt="RB" style="object-fit: cover; height: 220px;">
                <div class="card-body p-4 d-flex flex-column">
